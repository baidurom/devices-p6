...
.method constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v3, p0, v6}, Lcom/android/server/WifiService$AsyncServiceHandler;-><init>(Lcom/android/server/WifiService;Landroid/os/Looper;)V
    ...
    invoke-direct {v3, p0, v6}, Lcom/android/server/WifiService$WifiStateMachineHandler;-><init>(Lcom/android/server/WifiService;Landroid/os/Looper;)V
    ...
    invoke-direct {v3, p0, v6}, Lcom/android/server/WifiService$NotificationEnabledSettingObserver;-><init>(Lcom/android/server/WifiService;Landroid/os/Handler;)V
    ...
    :goto_1
    iput-boolean v4, p0, Lcom/android/server/WifiService;->mLastWifiEnabled:Z

    .line 704
    invoke-direct {p0}, Lcom/android/server/WifiService;->getAutoConnectEnabled()Z

    move-result v3

    iput-boolean v3, p0, Lcom/android/server/WifiService;->mLastWifiAutoConnectEnabled:Z
    ...
    .restart local v1       #idleIntent:Landroid/content/Intent;
...
.method private getAutoConnectEnabled()Z
    ...
    const-string v4, "Error getAutoConnectEnabled"
...
.method private updateWifiState()V
    ...
    .line 1561
    .local v2, wifiAutoConnectEnabled:Z
    ...
    const-string v8, "updateWifiState wifiAutoConnectEnabled= "
    ...
    invoke-static {v6}, Lcom/android/server/WifiService$LockList;->access$3600(Lcom/android/server/WifiService$LockList;)I
    ...
    :cond_1
    :goto_1
    iget-boolean v6, p0, Lcom/android/server/WifiService;->mFirstConfig:Z
    ...
    :goto_2
    iput-boolean v6, p0, Lcom/android/server/WifiService;->mLastWifiEnabled:Z

    .line 1593
    iput-boolean v2, p0, Lcom/android/server/WifiService;->mLastWifiAutoConnectEnabled:Z
    ...
    .restart local v3       #wifiShouldBeStarted:Z
    :cond_7
    iget-boolean v6, p0, Lcom/android/server/WifiService;->mAutoConnectSupport:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/WifiService;->mLastWifiEnabled:Z

    if-eqz v6, :cond_8

    iget-boolean v6, p0, Lcom/android/server/WifiService;->mLastWifiAutoConnectEnabled:Z
...
.method public updateWifiLockWorkSource(Landroid/os/IBinder;Landroid/os/WorkSource;)V
    ...
    invoke-static {v6, p1}, Lcom/android/server/WifiService$LockList;->access$4500(Lcom/android/server/WifiService$LockList;Landroid/os/IBinder;)I
...
.method public updateWifiStateEx()V
    .locals 0
